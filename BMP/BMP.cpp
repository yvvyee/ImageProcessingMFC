...
BEGIN_MESSAGE_MAP(CBMPApp, CWinAppEx)
...
CBMPApp::CBMPApp() noexcept
{
	...
	SetAppID(_T("BMP.AppID.NoVersion"));
...
// CBMPApp customization load/save methods
...
void AfxNewImage(CDib& dib) {
	CBMPApp* pApp = (CBMPApp*)AfxGetApp();
	pApp->m_pNewDib = &dib;
